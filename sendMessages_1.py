...
def getRCToken(ENV,userName,extNum,passWord,grant_Type): #定义方法，传env,用户名，密码，认证方式
    ...
    if ENV == "XIA_lab" or ENV == "Tina_sandbox" or ENV == "Adela_sandbox":
...
# run('Steve_sandbox','18886163913','101','Test!123',1,1, 'note','aab')
run('Tina_sandbox','18002491122','106','Test!123',1,1, 'task', "n5e")
