...
run(os.getenv('ENV'),os.getenv('RCNumber'),os.getenv('RCExtension'),os.getenv('RCPassword'),int(os.getenv('TeamCount')),int(os.getenv('MessageCountPerTeam')),os.getenv('type'))
...
# run('XIA_lab','18002491122','106','Test!123',1,1, 'task')
